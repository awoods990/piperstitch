#!/usr/bin/env python3
"""
Independent DST validation oracle used only by StitchPilotCoreTests
(see TESTING.md). Parses a DST file with pyembroidery (a separate
...
def main() -> None:
    if len(sys.argv) != 2:
        print("usage: validate_dst.py <path.dst>", file=sys.stderr)
        sys.exit(2)
